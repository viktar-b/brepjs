...
export { bodySolids, measureProductBodyVolume } from './types/productBody.js';
export type { NonEmpty, ProductBody, ProductBodyVolumeDependencies } from './types/productBody.js';
