...
| Assembly set-out, complete Model, Projection, export                                          | [set-out and dimensions](references/setoutAndDimensions.md), then [model and projection](references/modelAndProjection.md) | Every calibrated number has one owner; stable keys/Frames compose; IFC validates and reimports. |
