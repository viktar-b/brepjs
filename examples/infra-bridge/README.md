...
The sign backing and visible lettering are authored geometry. A bundled owned project font is loaded through the public text API, converted from glyph Blueprints to Profile IR, and extruded inside the declarative `BridgeNameSign` Family.
